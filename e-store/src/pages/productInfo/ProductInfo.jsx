...
import { useParams } from "react-router-dom"; // Fixed import from react-router-dom
                            ...
                            <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                                <div>
                                    <img
                                        ...
                                        alt={product?.title || "Product image"} // Improved alt attribute
                                    />
                                </div>
                            </div>
                                    ...
                                    <div className="flex flex-wrap items-center mb-6">
                                        {cartItems.some((p) => p.id === product.id) ? (
                                            ...
                                            <button
                                                ...
                                                className="w-full px-4 py-3 text-center text-gray-100 bg-red-900 border border-transparent hover:border-red-500 hover:bg-red-100 hover:text-red-900 rounded-xl"
                                            >
                                                Add to cart
                                            </button>
                                        )}
